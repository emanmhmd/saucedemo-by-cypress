# saucedemo-by-cypress

This repository contains automated test cases for the saucedemo web application using Cypress and JavaScript. The test suite covers various scenarios.    
